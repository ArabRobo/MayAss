...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6854007886:AAF40CECIIE9RSPfd14M5lilb-Ovixug_Ic")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002060091966"))
...
FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1001958098606"))
FORCE_SUB_2 = int(os.environ.get("FORCE_SUB_2", "-1001725207342"))
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "5804863120").split())]
except ValueError:
